...
from PyQt5.QtGui import QIcon, QMouseEvent, QKeySequence, QPixmap
...
class Browser(QMainWindow):
    def __init__(self):
        ...
        # Set up shortcut for opening a new tab
    ...
    def update_tab_icon(self, browser, icon):
        index = self.browser_tabs.indexOf(browser)
        if index != -1:
            self.browser_tabs.setTabIcon(index, QIcon(icon))


app = QApplication(sys.argv)
app.setApplicationName("Cwanda")
app.setWindowIcon(QIcon('fiverr_icon.png'))
